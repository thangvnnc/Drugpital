...
Base.encodeSha512 = (string) => {
    return crypto.createHash("sha512").update(string).digest('hex');
};

Base.timeNow = () => {
    return Base.formatDate(new Date(), "yyyyMMddHHmmssSSS");
};

Base.formatDate = (date, format, utc) => {
 ...
 */
Base.isFieldsNotNull = (object, fields) => {
